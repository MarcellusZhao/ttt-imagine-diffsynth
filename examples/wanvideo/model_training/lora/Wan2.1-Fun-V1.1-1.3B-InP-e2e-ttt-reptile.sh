#!/usr/bin/env bash
# Reptile E2E-TTT meta-training for Wan2.1-Fun-V1.1-1.3B-InP. Identical to
# Wan2.1-Fun-V1.1-1.3B-InP-e2e-ttt.sh except the YAML sets --e2e_algorithm reptile, which adapts
...
#   bash examples/wanvideo/model_training/lora/Wan2.1-Fun-V1.1-1.3B-InP-e2e-ttt-reptile.sh
#   ... --config <other.yaml>            # or point at the smoke config
set -e

CONFIG="${1:-examples/wanvideo/model_training/configs/Wan2.1-Fun-V1.1-1.3B-InP-e2e-ttt-reptile.yaml}"
