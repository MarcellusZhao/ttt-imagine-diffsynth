#!/usr/bin/env bash
# E2E-TTT meta-training for Wan2.1-Fun-V1.1-1.3B-InP. All knobs live in the YAML config;
# pass extra CLI flags after --config to override individual values.
#   bash examples/wanvideo/model_training/lora/Wan2.1-Fun-V1.1-1.3B-InP-e2e-ttt.sh
#   ... --config <other.yaml>            # or point at the smoke config
set -e

CONFIG="${1:-examples/wanvideo/model_training/configs/Wan2.1-Fun-V1.1-1.3B-InP-e2e-ttt-maml-smoke.yaml}"
