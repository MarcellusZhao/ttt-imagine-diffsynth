#!/usr/bin/env bash
# Chunk-by-chunk VBench sampling with Wan2.1-T2V-1.3B, WITH inter-chunk
# conditioning (each chunk seeded on the previous chunk via the V2V path), then
# print the per-dimension evaluation commands.
#
...
SAVE_PATH="${SAVE_PATH:-/home/hzhao/ttt-imagine-diffsynth/results/vbench/Wan2.1-T2V-1.3B-chunk-by-chunk-with-conditioning}"
