#!/usr/bin/env bash
# Chunk-by-chunk VBench sampling with Wan2.2-TI2V-5B, WITHOUT inter-chunk
...
SAVE_PATH="${SAVE_PATH:-/home/hzhao/ttt-imagine-diffsynth/results/vbench/Wan2.2-TI2V-5B-chunk-by-chunk-without-conditioning}"
