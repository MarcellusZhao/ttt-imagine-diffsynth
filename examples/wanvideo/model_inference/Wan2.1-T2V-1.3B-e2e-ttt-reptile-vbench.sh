...
SAVE_PATH="${SAVE_PATH:-/home/hzhao/ttt-imagine-diffsynth/results/vbench/Wan2.1-T2V-1.3B-e2e-ttt-reptile}"

# 1) All dimensions: 1 video per prompt.
python "$SCRIPT_DIR/Wan2.1-T2V-1.3B-e2e-ttt-vbench.py" \
    --config "$CONFIG" \
    --algorithm reptile \
    --lora /home/hzhao/ttt-imagine-diffsynth/models/train/Wan2.1-T2V-1.3B_e2e_ttt_reptile_smoke-20260605-224836/epoch-0.safetensors \
    --dimension all \
    --save_path "$SAVE_PATH" \
